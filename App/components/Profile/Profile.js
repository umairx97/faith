            ...
            {/* <View
						...
						<View
							...
							<View
								...
								<Text
									style={styles.likesText}>Likes</Text>
								<View
									pointerEvents="box-none"
									style={{
										flexDirection: "row",
						...
						<View
							...
							<View
								...
								<View
									pointerEvents="box-none"
									style={styles.rectangle2TwoView}>
									<View
										pointerEvents="box-none"
										style={{
											flex: 1,
								...
								<Text
									style={styles.visitsText}>Visits</Text>
								<View
									pointerEvents="box-none"
									style={{
										flexDirection: "row",
							...
							<View
								...
								<View
									pointerEvents="box-none"
									style={styles.iconsLikeCopyView}>
									<View
										pointerEvents="box-none"
										style={{
											flexDirection: "row",
						...
						<View
							...
							<View
								...
								<View
									...
									<Text
										style={styles.groupsText}>Groups</Text>
									<View
										pointerEvents="box-none"
										style={{
											flexDirection: "row",
            ...
            {/* <View
						...
						<View
							...
							<View
								...
								<Text
									style={styles.myWalletText}>My wallet</Text>
								<View
									pointerEvents="box-none"
									style={{
										flexDirection: "row",
						...
						<View
							...
							<View
								...
								<Text
									style={styles.vipCenterText}>VIP center</Text>
								<View
									pointerEvents="box-none"
									style={{
										flexDirection: "row",
						...
						<View
							...
							<View
								...
								<View
									pointerEvents="box-none"
									style={styles.rectangle2SixView}>
									<View
										pointerEvents="box-none"
										style={{
											flex: 1,
								...
								<Text
									style={styles.findFriendsText}>Find friends</Text>
								<View
									pointerEvents="box-none"
									style={{
										flexDirection: "row",
						...
						<View
							...
							<View
								...
								<Text
									style={styles.blacklistText}>Blacklist</Text>
								<View
									pointerEvents="box-none"
									style={{
										flexDirection: "row",
