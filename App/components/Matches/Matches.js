...
import { Text, View, ListItem, FlatList, BackHandler,Image } from 'react-native'
                    ...
                    renderItem={({ item }) => (
                        <View style={{ margin: 5 }}>
                            <View style={{ flexDirection: 'row' }}>
                                <View><Image style={{height:80,width:80, margin:3, resizeMode:'cover', borderRadius:40}} source={{uri:item.pUrl}}></Image></View>
