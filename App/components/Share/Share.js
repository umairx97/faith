...
export default class TestShare extends Component {
  ...
  onCancel() {
    // console.log("CANCEL");
    this.setState({visible:false, visibleAndroid: false});
  }
  onOpen() {
    console.log("OPEN")
  ...
  render() {
    ...
    return (
      ...
      <LinearGradient
        ...
        <TouchableOpacity onPress={()=> this.setState({visibleAndroid: true})}>
          <View style={styles.instructions}>
            <Text style={styles.TextStyle}>Share Android</Text>
          </View>
        </TouchableOpacity>

        <TouchableOpacity onPress={this.onOpen.bind(this)}>
          <View style={styles.instructions}>
            <Text style={styles.TextStyle}>Share IOS App</Text>
          </View>
        </TouchableOpacity>
        ...
        <ShareSheet visible={this.state.visible} onCancel={this.onCancel.bind(this)}>
          <Button iconSrc={{ uri: TWITTER_ICON }}
              ...
              this.onCancel();
              setTimeout(() => {
                Share.shareSingle(Object.assign(shareAndroid, {
                  "social": "twitter"
                }));
              },300);
            }}>Twitter</Button>
          ...
          <Button
            ...
            onPress={()=>{
              this.onCancel();
              setTimeout(() => {
                if(typeof shareAndroid["url"] !== undefined) {
                  Clipboard.setString(shareAndroid["url"]);
          ...
          <Button iconSrc={{ uri: MORE_ICON }}
            onPress={()=>{
              this.onCancel();
              setTimeout(() => {
                Share.open(shareAndroid)
              },300);
            }}>More</Button>
        </ShareSheet>
        <ShareSheet visible={this.state.visibleAndroid} onCancel={this.onCancel.bind(this)}>
          <Button iconSrc={{ uri: TWITTER_ICON }}
                  onPress={()=>{
              this.onCancel();
              setTimeout(() => {
                Share.shareSingle(Object.assign(shareIOS, {
                  "social": "twitter"
                }));
              },300);
            }}>Twitter</Button>
          ...
          <Button
            ...
            onPress={()=>{
              ...
              setTimeout(() => {
                if(typeof shareAndroid["url"] !== undefined) {
                  Clipboard.setString(shareIOS["url"]);
                  if (Platform.OS === "android") {
                    ToastAndroid.show('Link copiado al portapapeles', ToastAndroid.SHORT);
                  } else if (Platform.OS === "ios") {
                    AlertIOS.alert('Link copiado al portapapeles');
