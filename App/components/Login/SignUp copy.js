...
export default class SignUp extends Component {
  ...
  _onSubmit(){
    const{
      _full_name,_user_name,_email,_password,_dob,_gender
    }=this.state;
    if(_full_name===""){
      this._showSnackBar("Please enter full name")
    }
    else if(_user_name==="")
    {
this._showSnackBar("Please enter user name")
    }
    else if(_email==="")
    {
      this._showSnackBar("Please enter email Id")
    }
    else if(!this.validateEmail(_email))
    {
      this._showSnackBar("Please enter valid email Id")
    }
    else if(_password==="")
    {
      this._showSnackBar("Please enter password")
    }
    
  }
  _showSnackBar(title1){
    Snackbar.show({
      title:title1,
      ...
      <View>
        <View style={
          ...
          <View style={
            ...
            <Text>Full Name</Text>
            <TextInput onChangeText={(value)=>this.setState({_full_name:value})} placeholder="Please enter your name"
              style={
                styles.textInput
              }
            />
