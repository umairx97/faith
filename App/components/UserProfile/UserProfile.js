...
and perspective that my reading gives me has strengthened my teaching skills and presentation abilities.opportunities, through which I was able to have fewer returned products and increased repeat customers, when compared with co-workers.</Text>
					...
					<View
						...
						<View
							...
							<Text
								style={styles.basicProfileText}>Basic profile</Text>
							<View
								pointerEvents="box-none"
								style={{
									flexDirection: "row",
								...
								<Text
									style={styles.singleText}>Single</Text>
							</View>
						</View>
						<Text
							style={styles.cmText}>160cm</Text>
						<Text
							style={styles.kgText}>65kg</Text>
						<View
							pointerEvents="box-none"
							style={{
								flex: 1,
							...
							<Text
								style={styles.dec252017Text}>Dec 25, 2017</Text>
						</View>
					</View>
					<View
						pointerEvents="box-none"
						...
						<View
							...
							<View
								...
								<View
									...
									<View
										...
										<Text
											style={styles.guitarText}>Guitar</Text>
									</View>
								</View>
								<View
									pointerEvents="box-none"
							...
							<View
								...
								<Text
									style={styles.interestingText}>Interesting</Text>
								<View
									pointerEvents="box-none"
									style={{
										flex: 1,
						...
						<View
							pointerEvents="box-none"
							style={styles.lookingForView}>
							<Text
								style={styles.lookingForText}>Looking for</Text>
							<View
								pointerEvents="box-none"
								style={{
									flex: 1,
