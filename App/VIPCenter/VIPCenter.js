		 ...
		 <View
				...
				<View
					...
					<LinearGradient
						...
						locations={[0, 0.61, 1]}
						colors={['rgb(255, 97, 163)', 'rgb(150, 72, 242)', 'rgb(90, 82, 242)']}
								...
								<View
									...
									<View
										...
										<View
											...
											<Text
												style={styles.vipMemberText}>VIP Mem</Text>
										</View>
									</View>
								</View>
							</View>
							<Text
								style={styles.congratulationsText}>Congratulations</Text>
							<View
								pointerEvents="box-none"
								style={{
									flex: 1,
								...
								<Text
									style={styles.expirationDateAprText}>Expiration Date: April 31, 2019 </Text>
								<LinearGradient
									start={{
										x: 0.76,
										y: 0.5,
									...
									<View
										...
										<Text
											style={styles.renewalText}>Renewal</Text>
									</View>
								</LinearGradient>
							</View>
							<View
					...
					<View
						...
						<View
							...
							<View
								...
								<Image
									source={require("../../assets/images/icons-vip-center.png")}
									style={styles.iconsVipCenterImage}/>
								<View
									pointerEvents="box-none"
									style={{
										flexDirection: "row",
									...
									<Text
										style={styles.vipPrivilegeText}>VIP PRIVILEGE</Text>
								</View>
							</View>
							<View
								pointerEvents="box-none"
								...
								<Text
									style={styles.seeWhoLikedYouText}>See who liked you</Text>
								<View
									pointerEvents="box-none"
									style={{
										flex: 1,
									...
									<View
										...
										<Text
											style={styles.youWillBeOnSpotlText}>You will be on spotlight and be seen by thousands </Text>
									</View>
								</View>
								<View
									pointerEvents="box-none"
									...
									<View
										...
										<Text
											style={styles.youLlSeeEveryoneText}>You'll see everyone who liked you</Text>
										<View
											pointerEvents="box-none"
											style={{
												flex: 1,
									...
									<View
										...
										<Text
											style={styles.seeWhoVisitedYouText}>See who visited you</Text>
										<Text
											style={styles.youLlSeeEveryoneCopyText}>You'll see everyone who liked you</Text>
										<View
											pointerEvents="box-none"
											style={{
												flex: 1,
									...
									<View
										...
										<View
											...
											<Text
												style={styles.unlimitedRewindsText}>Unlimited rewinds</Text>
										</View>
									</View>
									<View
										pointerEvents="box-none"
										...
										<Text
											style={styles.incognitoModeText}>Incognito mode</Text>
										<Text
											style={styles.youCanBrowseOtherText}>You can browse others anonymously</Text>
										<View
											pointerEvents="box-none"
											style={{
												flex: 1,
									...
									<View
										...
										<Text
											style={styles.extraSuperlikesText}>Extra superlikes</Text>
										<Text
											style={styles.youCanSuperlikeUpText}>You can superlike up to 5 times a day</Text>
										<View
											pointerEvents="box-none"
											style={{
												flex: 1,
